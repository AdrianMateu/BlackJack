!(function (n, r) {
	...
	var W = j(function (n, t, e) {
		...
		return (
			Cn(t)
				? (o = t)
				: Kn(t) && ((u = t.slice(0, -1)), (t = t[t.length - 1])),
			N(n, function (n) {
				var r = o;
				if (!r) {
	...
	function tn(n) {
		for (
			var r = (n && P(n, O).length) || 0, t = Array(r), e = 0;
			e < r;
			e++
		)
			t[e] = z(n, e);
	...
	function pr(r) {
		...
		return function (n) {
			return (
				(n = null == n ? "" : "" + n), e.test(n) ? n.replace(u, t) : n
			);
		};
	}
	var sr = pr(cr),
	...
	var wr = _r({
		...
		intersection: function (n) {
			for (
				var r = [], t = arguments.length, e = 0, u = O(n);
				e < u;
				e++
			) {
				var o = n[e];
